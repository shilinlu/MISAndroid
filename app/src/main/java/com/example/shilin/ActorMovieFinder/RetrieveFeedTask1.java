 ...
 */
public class RetrieveFeedTask1  extends AsyncTask <Void, Void, String> implements Serializable {
    private Exception exception;
    private ArrayList<Actor> actors=new ArrayList();
    int search=0;
    String responses="";
    public AsyncResponse delegate = null;
    public RetrieveFeedTask1(int search) {
        if(search<1){
            search=1;
        }
        this.search=search;
    ...
    protected String doInBackground(Void... urls) {
        ...
        try {
            ...
            String url=movieDb.getFilmographyQuery(search);
