 ...
 */
public class RetrieveFeedTask  extends AsyncTask <Void, Void, String> implements Serializable {
    private Exception exception;
    private ArrayList<Actor> actors=new ArrayList();
    String search="";
    String responses="";
    public AsyncResponse delegate = null;
    public RetrieveFeedTask(String search) {
    ...
    protected String doInBackground(Void... urls) {
        ...
        try {
            ...
            String url=movieDb.getActorQuery(search);
